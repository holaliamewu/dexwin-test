  ...
  <div>
    ...
    <section className="bg-white w-[90%] text-black mx-auto" >
        <motion.h1 
          ...
          viewport={{ once: true }}
        className="mt-12 md:mt-[96px] mb-4 text-7xl md:text-[80px] font-bold">We are <span className="text-[#02aa69] " 
        >DEXWIN</span>
        </motion.h1>
        <motion.p 
          initial={{ opacity: 0, y: 20 }}
        ...
        viewport={{ once: true }}
        src="/dexwin_assets/about-page-image.png" 
        alt="About Us" 
        className="w-full h-[600px] mt-8 object-cover bg-center md:object-fit rounded-3xl shadow-lg" />
    </section>
