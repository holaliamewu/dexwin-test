...
export default function ContactPage() {
  ...
  <div>
    ...
    <section className="flex flex-col bg-white w-[90%] mx-auto text-black py-6 md:py-[100px]" >
          <div className="flex items-end gap-4 w-fit mb-[64px] " >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12" >
              {
                faqsData.map((faq) => (
                  <span key={faq.question} className=" px-6 py-10 rounded-lg " >
                    <h3 className="text-[24px] font-semibold mb-2" >{faq.question}</h3>
